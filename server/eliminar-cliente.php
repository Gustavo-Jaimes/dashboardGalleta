<?php 
    ...
    if (isset($_POST['deletedata_cliente'])) {
        
        $delete_id_cliente = $_POST['delete_id_cliente'];
        ...
        //         $thumbs5_path = "../../../autodealgmkt/imagenes/galeria/".$rows['foto_5'];
                ...
                $query = mysqli_query($conexion, "DELETE FROM campanas WHERE id_campana = '".$delete_id_cliente."'");
